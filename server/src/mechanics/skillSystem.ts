...
const ACTION_SKILL_MAP: Record<ActionCode, { primary: SkillCategory; secondary?: SkillCategory }> = {
    ...
    POST_JOB_OFFER: { primary: 'leadership', secondary: 'trading' },
    APPLY_FOR_JOB: { primary: 'scholarship', secondary: 'trading' },
    HIRE_EMPLOYEE: { primary: 'leadership', secondary: 'scholarship' },
    FIRE_EMPLOYEE: { primary: 'leadership', secondary: 'combat' },
